...
let indexMax = changes.indexOf(greatestIncrease) + 1
let indexMin = changes.indexOf(greatestDecrease) + 1
let maxMonth = finances[indexMax][0]
let minMonth = finances[indexMin][0]
